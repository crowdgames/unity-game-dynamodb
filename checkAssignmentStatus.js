 ...
 */
var aws_access_key_id = 'AKIAIL2Z5ZOO4LNOTDFA';
var aws_secret_access_key = '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';
...
var params1 = {
  HITId: myHITId, /* required */
};

mturk.listAssignmentsForHIT(params1, function(err, data) {
  if (err) console.log(err, err.stack); // an error occurred
  else     console.log(data);           // successful response
});

//mturk.getHIT(params1, function(err, data) {
  //if (err) console.log(err, err.stack); // an error occurred
  //else     console.log(data);           // successful response
//});